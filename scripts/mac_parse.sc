...
def parser : Unit = {
  ...
  println("""     and rule tables, such as "horace-morphology") and hit return/enter. This""")
  println("     will create your parser under the same name as the morphology.")
  println("""     Ex: compile("horace-morphology")""")
  ...
  println("""     Note that the default parser is "horace-morphology" for this repository, so """)
  println("     you do not need to type the parser after the edition if you are parsing Horace.")
  ...
  println("     function.")
  println("""     Ex: parse("ode1_38.txt", "horace-morphology")""")
